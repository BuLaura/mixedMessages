const fortuneCookie = {
    time: ['Yesterday', 'Day after tomorrow', 'Never', 'Always', 'Next year', 'Your entire life', 'Today', 'Sometimes', 'Last year', 'Next month', 'Next week', 'Next summer', 'Next winter'],
    wisdom: ['count back words until you see', 'remember to smile for', 'is going to pay of so remember', 'forget to regret', 'do not hold onto', 'look back at', 'realize how much you love', 'sit in silence with', 'go out of your way for'],
